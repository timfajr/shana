...
<div class="Navbar">
    <Navbar />
<section class="h-min-screen text-gray-400 bg-gray-900 body-font">
  <div class="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Berbagi Besama, Yuk</h1>
      <p class="mb-8 leading-relaxed">Bahagia itu sederhana, tersenyum bersama dan berbagi duka bersama akan menjadi hal terindah.</p>
      <div class="flex w-full md:justify-start justify-center items-end">
        <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
          <label for="hero-field" class="leading-7 text-sm text-gray-400">Jumlah yang di donasikan</label>
          <input type="text" id="hero-field" name="hero-field" class="w-full bg-gray-800 rounded border bg-opacity-40 border-gray-700 focus:ring-2 focus:ring-yellow-900 focus:bg-transparent focus:border-yellow-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
        </div>
      ...
      <p class="text-sm mt-2 text-gray-500 mb-8 w-full">Jangan lupa unduh Apps kami , Terima kasih.</p>
